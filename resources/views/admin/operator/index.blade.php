...
@section('content-bc', 'Data Operator ')
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            <a href="{{ route('admin.operator.edit', ['id' => ':id']) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-key"></i>
                            </a>
                            <a href="{{ route('admin.operator.change', ['id' => ':id']) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-edit"></i>
                            </a>
                        `.replace(':id', data.id).replace(':id', data.id);
                        }
                    }
                ]
            });
            ...
            $('#tabelData').on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let deleteUrl = '{{ route('admin.operator.delete', ':id') }}';
        ...
        <div class="col-xl-12">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Token</h3>
                    <div class="block-options">
                        <a href="{{ route('admin.operator.create') }}" class="btn btn-primary">Tambah Data</a>
                    </div>
                </div>
