                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            <a href="{{ route('admin.admin.edit', ['id' => ':id']) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-key"></i>
                            </a>
                            <a href="{{ route('admin.admin.change', ['id' => ':id']) }}" class="btn btn-sm btn-primary">
            ...
            $('#tabelData').on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let deleteUrl = '{{ route('admin.admin.delete', ':id') }}';
