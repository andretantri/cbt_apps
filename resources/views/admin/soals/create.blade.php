...
@section('js')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const kategori = '{{ $kategori }}'; // Mengambil kategori dari backend
            ...
            const updatePoinOptions = () => {
                ...
                poinSelects.forEach(select => {
                    ...
                    let availableOptions = poinOptions[kategori].filter(opt =>
                        !selectedValues.includes(String(opt)) || String(opt) ===
                        currentValue // Izinkan pilihan yang sudah dipilih di select ini
                    );
...
@section('content-isi')
    <div class="block block-rounded">
        <div class="block-content block-content-full">
            ...
            <form action="{{ route('admin.soal.store.cat', ['kategori' => $kategori, 'sub' => $sub]) }}" method="POST"
                ...
                <div class="row push">
                    <div class="col-lg-12 col-xl-12 overflow-hidden">
                        ...
                        <div class="mb-4">
                            ...
                            <img id="soal-preview" src="#" alt="Preview Gambar Soal"
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" type="text" name="option_{{ $option }}" id="option_{{ $option }}"></textarea>
                                    </div>
                                    <div class="col-md-4">
