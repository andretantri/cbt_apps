...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var url = '{{ route('admin.get.soal.cat', ['kategori' => $kategori, 'sub' => $sub]) }}';
            ...
            $('#tabelData').on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let deleteUrl = '{{ route('admin.soal.delete.cat', ':id') }}';
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <a href="{{ route('admin.soal.create.cat', ['kategori' => $kategori, 'sub' => $sub]) }}"
