                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `
                            <a href="{{ route('admin.token.edit', ['id' => ':id']) }}" class="btn btn-sm btn-primary">
            ...
            $('#tabelData').on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let deleteUrl = '{{ route('admin.token.delete', ':id') }}';
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <a href="{{ route('admin.token.create') }}" class="btn btn-primary">Tambah Data</a>
                    </div>
                </div>
