<head>
    ...
    <<<<<<< HEAD <meta property="og:site_name" content="CBT">
        <meta property="og:description" content="APP CBT">
        =======
        <meta property="og:site_name" content="Lantana">
        <meta property="og:description" content="APP CBT Test">
        >>>>>>> 8e5f6640b4c2667750a170cb0e5585ef303abbaa
        ...
        <link rel="shortcut icon"
            href="{{ asset('template/assets/media/favicons/favicon.png') }}">
        <link rel="icon" type="image/png" sizes="192x192"
        ...
        <link rel="stylesheet" id="css-main"
            href="{{ asset('template/assets/css/dashmix.min.css') }}">
        <!-- END Stylesheets -->
</head>
