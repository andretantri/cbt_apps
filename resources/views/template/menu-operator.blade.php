<ul class="nav-main">
    <li class="nav-main-item">
        <a class="nav-main-link {{ activeMenu('dashboard') }}" href="{{ route('operator.dashboard') }}">
        ...
        <ul class="nav-main-submenu">
                ...
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TWK', 'sub' => 'Bagian 1']) }}">
                            <span class="nav-main-link-name">Bagian 1</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TWK', 'sub' => 'Bagian 2']) }}">
                            <span class="nav-main-link-name">Bagian 2</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TWK', 'sub' => 'Bagian 3']) }}">
                            <span class="nav-main-link-name">Bagian 3</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TWK', 'sub' => 'Bagian 4']) }}">
                            <span class="nav-main-link-name">Bagian 4</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TWK', 'sub' => 'Bagian 5']) }}">
                            <span class="nav-main-link-name">Bagian 5</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TWK', 'sub' => 'Bagian 6']) }}">
            ...
            <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Analogi']) }}">
                            <span class="nav-main-link-name">Analogi</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Silogisme']) }}">
                            <span class="nav-main-link-name">Silogisme</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Deret']) }}">
                            <span class="nav-main-link-name">Deret</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Hitung Cepat']) }}">
                            <span class="nav-main-link-name">Hitung Cepat</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Aritmatika Sosial']) }}">
                            <span class="nav-main-link-name">Aritmatika Sosial</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Perbandingan Cerita']) }}">
                            <span class="nav-main-link-name">Perbandingan Cerita</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Analitis']) }}">
                            <span class="nav-main-link-name">Analitis</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TIU', 'sub' => 'Figural']) }}">
            ...
            <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                        <a class="nav-main-link"
                            href="{{ route('operator.soal.cat', ['kategori' => 'TKP', 'sub' => 'Random']) }}">
    ...
    <li class="nav-main-item">
        <a class="nav-main-link {{ activeMenu('ujian') }}" href="{{ route('operator.ujian') }}">
            <i class="nav-main-link-icon fa fa-pencil"></i>
            <span class="nav-main-link-name">Ujian</span>
        </a>
    </li>
    <li class="nav-main-item">
        <a class="nav-main-link {{ activeMenu('token') }}" href="{{ route('operator.token') }}">
            <i class="nav-main-link-icon fa fa-calendar"></i>
            <span class="nav-main-link-name">Token Ujian</span>
        </a>
    </li>
    <li class="nav-main-item">
        <a class="nav-main-link {{ activeMenu('laporan') }}" href="{{ route('operator.laporan') }}">
