...
class LaporanController extends Controller
{
    public function index()
    {
        ...
        return view('admin.laporan.index', compact('exams'));
    }
    ...
    public function report(Request $request)
    {
        ...
        return view('admin.laporan.getdata', compact('examAnswers', 'examId', 'token'));
    }
    ...
    public function printUserExam($id)
    {
        ...
        return view('admin.laporan.user', ['data' => $uses, 'info' => $userData]);
    }
}
