...
class OperatorSoalManage extends Controller
{
    public function index($kategori, $sub)
    {
        return view('operator.soals.index', ['kategori' => $kategori, 'sub' => $sub]);
    }
    ...
    {
        return view('operator.soals.create', ['kategori' => $kategori, 'sub' => $sub]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator.soal.cat', ['kategori' => $request->kategori, 'sub' => $request->sub])->with('success', 'Data berhasil ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.soals.edit', compact('soal', 'poinOptions', 'kategori', 'sub'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('operator.soal.cat', ['kategori' => $request->kategori, 'sub' => $request->sub])->with('success', 'Data berhasil diubah!');
    }
