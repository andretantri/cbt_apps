...
class SoalController extends Controller
{
    ...
    {
        return view('operator.soal.index');
    }
    ...
    {
        return view('operator.soal.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator.soal')->with('success', 'Data berhasil ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.soal.edit', compact('data'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        $question->scoring_type =  $request->kategori;
        ...
        return redirect()->route('operator.soal')->with('success', 'Data berhasil diubah!');
    }
