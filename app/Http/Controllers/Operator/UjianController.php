...
class UjianController extends Controller
{
    ...
    {
        return view('operator.ujian.index');
    }
    ...
    {
        return view('operator.ujian.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator.ujian')->with('success', 'Data berhasil ditambahkan!');
    }
    ...
    {
        $data = Exam::find($id);
        return view('operator.ujian.edit', compact('data'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('operator.ujian')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function tabel($id)
    {
        ...
        return view('operator.ujian.tabel', compact('data', 'ujian', 'id'));
    }
    ...
    public function pertanyaan($id, $kategori, $sub, $order)
    {
        ...
        $ujian = Exam::find($id);
        return view('operator.ujian.set', ['pertanyaan' => $pertanyaan, 'ujian' => $ujian, 'list' => $lq, 'order' => $order]);
    }
    ...
    public function storex($id, Request $request)
    {
        ...
        return redirect()->route('operator.ujian.tabel', ['id' => $id])->with('success', 'Data berhasil diupdate!');
    }
