...
class TokenController extends Controller
{
    ...
    {
        return view('operator.token.index');
    }
    ...
    {
        $exam = Exam::all();
        return view('operator.token.create', ['exam' => $exam]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator.token')->with('success', 'Token Berhasil Dibuat!');
    }
    ...
    public function edit($id)
    {
        $data = Token::find($id);
        $exam = Exam::all();
        return view('operator.token.edit', compact('data', 'exam'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('operator.token')->with('success', 'Token Berhasil Diubah!');
    }
}
